...
Bihar is one of India's most populous states and faces significant child health challenges. This project digs into NFHS-5 district-level data to understand how child malnutrition, breastfeeding, and health outcomes vary across regions.
...
This is a beginner-level EDA project — one of my first attempts at working with real government survey data. The goal was to practice data cleaning, visualization, and drawing meaningful insights from health indicators.
